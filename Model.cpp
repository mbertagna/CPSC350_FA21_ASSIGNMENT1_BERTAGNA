...
string Model::translateDoubleCharacter(char doubleCharInput){
  ...
  if(doubleCharInput == tolower(doubleCharInput)){
    //if vowel
    if(doubleCharInput == 'a' || doubleCharInput == 'e' || doubleCharInput == 'i' || doubleCharInput == 'o' || doubleCharInput == 'u'){
      tutneseString += "squat";
      tutneseString += doubleCharInput;
    }
    //if consonant
    else{
      tutneseString += "squa";
  ...
  //if double character is not lowercase, rather uppercase
  else{
    //if vowel
    if(doubleCharInput == 'A' || doubleCharInput == 'E' || doubleCharInput == 'I' || doubleCharInput == 'O' || doubleCharInput == 'U'){
      tutneseString += "Squat";
